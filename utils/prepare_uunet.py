...
dataset_root = "/media/wagnchogn/ssd_2t/lmy/FastSAM3D_copy/data/process_train_data"
dataset_list = [
    '10per'
]

target_dir = "/media/wagnchogn/ssd_2t/lmy/FastSAM3D_copy/data_10per"


for dataset in dataset_list:
    dataset_dir = osp.join(dataset_root, dataset)
    meta_info = json.load(open(osp.join(dataset_dir, "CVPR24_TextSegFMData_with_class.json")))
