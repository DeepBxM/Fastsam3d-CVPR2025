...
parser.add_argument('-o','--save_path', default='./output', type=str, help='segmentation output path')
parser.add_argument('-d','--docker_folder_path', default='./team_docker', type=str, help='team docker path')
parser.add_argument('-val_gts','--validation_gts_path', default='./validation_gts', type=str, help='path to validation set (or final test set) GT files')
